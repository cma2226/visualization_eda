---
title: "Visualization_EDA - ggplot2 continued"
...
For example, I frequently change the legend position. By default this is on the right of the graphic, but I like to shift it to the bottom to ensure the graphic takes up the available left-to-right space.
...
Sometimes struggles with ggplot are really struggles with data tidying in disguise. It can be easier to manipulate data within our dataset than manipulate ggplot, sometimes. An example of this is ordering categorical or factor variables. Default in ggplot is alphabetical. We can change this as follows:
